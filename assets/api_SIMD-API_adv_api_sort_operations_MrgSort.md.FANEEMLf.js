import{_ as e,o as a,a as s,b as l}from"./app.Dfzi9e7Q.js";const i="/assets/mrgsort4_01.zFxNrLCp.png",r="/assets/mrgsort4_02.DEM9tmYp.png",g=JSON.parse('{"title":"","description":"","frontmatter":{"breadcrumbs":[{"text":"Ascend C API","link":"/api/api_list"},{"text":"SIMD API","link":"/api/SIMD-API/SIMD-API"},{"text":"高阶API","link":"/api/SIMD-API/adv_api/adv_api"},{"text":"排序操作","link":"/api/SIMD-API/adv_api/sort_operations/sort_operations"},{"text":"MrgSort","link":"/api/SIMD-API/adv_api/sort_operations/MrgSort"}]},"headers":[],"relativePath":"api/SIMD-API/adv_api/sort_operations/MrgSort.md","filePath":"api/SIMD-API/adv_api/sort_operations/MrgSort.md","outlineHeaders":[{"level":2,"title":"产品支持情况","slug":"产品支持情况","link":"#产品支持情况"},{"level":2,"title":"功能说明","slug":"功能说明","link":"#功能说明"},{"level":2,"title":"函数原型","slug":"函数原型","link":"#函数原型"},{"level":2,"title":"参数说明","slug":"参数说明","link":"#参数说明"},{"level":2,"title":"返回值说明","slug":"返回值说明","link":"#返回值说明"},{"level":2,"title":"约束说明","slug":"约束说明","link":"#约束说明"},{"level":2,"title":"调用示例","slug":"调用示例","link":"#调用示例"}],"lastUpdated":1789956443000}'),n={name:"api/SIMD-API/adv_api/sort_operations/MrgSort.md"};function o(d,t,c,h,p,v){return a(),s("div",null,[...t[0]||(t[0]=[l('<div><article class="markdown-body"><h1>MrgSort</h1><h2 id="产品支持情况">产品支持情况<a class="header-anchor" href="#产品支持情况">​</a></h2><div data-filter="950"><ul><li>Ascend 950PR&amp;950DT系列产品：支持</li></ul></div><div data-filter="A3"><ul><li>Atlas A3系列产品：支持</li></ul></div><div data-filter="910b"><ul><li>Atlas A2系列产品：支持</li></ul></div><div data-filter="310b"><ul><li>Atlas 200I/500 A2推理产品：不支持</li></ul></div><div data-filter="310p"><ul><li>Atlas推理系列产品AI Core：支持</li><li>Atlas推理系列产品Vector Core：不支持</li></ul></div><div data-filter="910"><ul><li>Atlas训练系列产品：不支持</li></ul></div><h2 id="功能说明">功能说明<a class="header-anchor" href="#功能说明">​</a></h2><p>将已经排好序的最多4条队列，合并排列成1条队列，结果按照score域由大到小排序，排布方式如下：</p><div data-filter="950"><p>Ascend 950PR&amp;950DT系列产品采用方式一。</p></div><div data-filter="A3"><p>Atlas A3系列产品采用方式一。</p></div><div data-filter="910b"><p>Atlas A2系列产品采用方式一。</p></div><div data-filter="310p"><p>Atlas推理系列产品AI Core采用方式二。</p></div><ul><li><p>排布方式一：</p><p>MrgSort处理的数据一般是经过Sort处理后的数据，也就是Sort接口的输出，队列的结构如下所示：</p><ul><li><p>数据类型为float，每个结构占据8Bytes。</p><p><img src="'+i+'" alt></p></li><li><p>数据类型为half，每个结构也占据8Bytes，中间有2Bytes保留。</p><p><img src="'+r+`" alt></p></li></ul></li><li><p>排布方式二：Region Proposal排布</p><p>输入输出数据均为Region Proposal，具体请参见<a href="Sort.html">Sort</a>中的排布方式二。</p></li></ul><h2 id="函数原型">函数原型<a class="header-anchor" href="#函数原型">​</a></h2><div class="code-block"><div class="code-header"><span class="lang-label">Text</span><button class="copy-btn" title="复制代码"><svg width="16" height="16" viewBox="0 0 16 16"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button></div><pre class="highlight"><code>template &lt;typename T, bool isExhaustedSuspension = false&gt;
...
输出数据(dstIndexGm):
[127 126 125 ... 2 1 0]
</code></pre></div></li><li><p>处理64个half类型数据。</p><p>该样例适用于：</p><div data-filter="310p"><p>Atlas推理系列产品AI Core</p></div><div class="code-block"><div class="code-header"><span class="lang-label">Text</span><button class="copy-btn" title="复制代码"><svg width="16" height="16" viewBox="0 0 16 16"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button></div><pre class="highlight"><code>uint32_t elementCount = 64; // 元素个数
// 单条队列元素个数
uint32_t singleMergeTmpElementCount = elementCount / 4;
uint32_t baseOffset = AscendC::GetSortOffset&lt;half&gt;(singleMergeTmpElementCount);
// sortList：待合并的有序队列列表
