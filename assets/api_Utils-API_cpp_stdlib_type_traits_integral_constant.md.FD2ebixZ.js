import{_ as e,o as a,a as l,b as n}from"./app.Dfzi9e7Q.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{"breadcrumbs":[{"text":"Ascend C API","link":"/api/api_list"},{"text":"Utils API","link":"/api/Utils-API/Utils-API"},{"text":"C++标准库","link":"/api/Utils-API/cpp_stdlib/cpp_stdlib"},{"text":"类型特性","link":"/api/Utils-API/cpp_stdlib/type_traits/type_traits"},{"text":"integral_constant","link":"/api/Utils-API/cpp_stdlib/type_traits/integral_constant"}]},"headers":[],"relativePath":"api/Utils-API/cpp_stdlib/type_traits/integral_constant.md","filePath":"api/Utils-API/cpp_stdlib/type_traits/integral_constant.md","outlineHeaders":[{"level":2,"title":"产品支持情况","slug":"产品支持情况","link":"#产品支持情况"},{"level":2,"title":"功能说明","slug":"功能说明","link":"#功能说明"},{"level":2,"title":"函数原型","slug":"函数原型","link":"#函数原型"},{"level":2,"title":"参数说明","slug":"参数说明","link":"#参数说明"},{"level":2,"title":"约束说明","slug":"约束说明","link":"#约束说明"},{"level":2,"title":"返回值说明","slug":"返回值说明","link":"#返回值说明"},{"level":2,"title":"调用示例","slug":"调用示例","link":"#调用示例"}],"lastUpdated":1789956443000}'),s={name:"api/Utils-API/cpp_stdlib/type_traits/integral_constant.md"};function i(d,t,c,p,o,r){return a(),l("div",null,[...t[0]||(t[0]=[n(`<div><article class="markdown-body"><h1>integral_constant</h1><h2 id="产品支持情况">产品支持情况<a class="header-anchor" href="#产品支持情况">​</a></h2><div data-filter="950"><ul><li>Ascend 950PR&amp;950DT系列产品：支持</li></ul></div><div data-filter="A3"><ul><li>Atlas A3系列产品：支持</li></ul></div><div data-filter="910b"><ul><li>Atlas A2系列产品：支持</li></ul></div><div data-filter="310b"><ul><li>Atlas 200I/500 A2推理产品：不支持</li></ul></div><div data-filter="310p"><ul><li>Atlas推理系列产品AI Core：不支持</li><li>Atlas推理系列产品Vector Core：不支持</li></ul></div><div data-filter="910"><ul><li>Atlas训练系列产品：不支持</li></ul></div><h2 id="功能说明">功能说明<a class="header-anchor" href="#功能说明">​</a></h2><p>integral_constant是一个带有模板参数的结构体，定义在&lt;type_traits&gt;头文件中，用于封装一个编译时常量整数值，是标准库中许多类型特性和编译时计算的基础组件。</p><p>integral_constant的功能如下：</p><ol><li>封装编译时常量，将一个int或bool类型的值封装为特定类型，以便该值可以在编译时被操作和传递。</li><li>类型标识，每个不同的integral_constant实例都是唯一的类型，可用于模板特化或重载决议。</li><li>隐式转换时支持转换为其封装的值类型，便于在需要该值的上下文中直接使用。</li><li>函数调用运算符允许像调用函数一样调用实例，以获取其值。</li></ol><p>integral_constant提供了多个常用的特化版本，具体如下：</p><ul><li>Std::true_type：integral_constant&lt;bool, true&gt;的别名。</li><li>Std::false_type：integral_constant&lt;bool, false&gt;的别名。</li><li>数值常量：如Std::integral_constant&lt;int, 42&gt;。</li><li>数值常量的简化写法，Std::Int，数值类型为size_t：如Std::Int&lt;42&gt;。</li></ul><h2 id="函数原型">函数原型<a class="header-anchor" href="#函数原型">​</a></h2><div class="code-block"><div class="code-header"><span class="lang-label">Text</span><button class="copy-btn" title="复制代码"><svg width="16" height="16" viewBox="0 0 16 16"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button></div><pre class="highlight"><code>template &lt;typename Tp, Tp v&gt;
