import{_ as s,o as n,a as p,b as t}from"./app.Dfzi9e7Q.js";const o="/assets/copy_opt.WynA3fZF.png",c="/assets/dcpad_api.Ctq0YTJ4.png",e="/assets/loop_copy.BcBb5V-t.png",d="/assets/copy_data.BEm9EXEo.png",l="/assets/dcpad_copy.Csqa_CPg.png",i="/assets/copy_data_56.Cc0AAtcR.png",u=JSON.parse('{"title":"","description":"","frontmatter":{"breadcrumbs":[{"text":"Ascend C算子开发指南","link":"/guide/getting_started/ascend_c_overview_and_learning_path"},{"text":"算子实践参考","link":"/guide/operator_practice/document_structure"},{"text":"SIMD算子性能优化","link":"/guide/operator_practice/simd_operator_optimization/simd_operator_optimization"},{"text":"内存访问","link":"/guide/operator_practice/simd_operator_optimization/memory_access/memory_access"},{"text":"非连续搬运场景减少搬运次数","link":"/guide/operator_practice/simd_operator_optimization/memory_access/reduce_non_contiguous_transfer"}]},"headers":[],"relativePath":"guide/operator_practice/simd_operator_optimization/memory_access/reduce_non_contiguous_transfer.md","filePath":"guide/operator_practice/simd_operator_optimization/memory_access/reduce_non_contiguous_transfer.md","outlineHeaders":[{"level":2,"title":"使用Loop模式减少非连续搬运的次数","slug":"使用Loop模式减少非连续搬运的次数","link":"#使用Loop模式减少非连续搬运的次数"},{"level":2,"title":"使用多维数据搬运减少非连续搬运次数","slug":"使用多维数据搬运减少非连续搬运次数","link":"#使用多维数据搬运减少非连续搬运次数"}],"lastUpdated":1790236535000}'),r={name:"guide/operator_practice/simd_operator_optimization/memory_access/reduce_non_contiguous_transfer.md"};function m(C,a,P,g,y,_){return n(),p("div",null,[...a[0]||(a[0]=[t('<div><article class="markdown-body"><h1>非连续搬运场景减少搬运次数<span id="ZH-CN_TOPIC_0000002529778475"></span></h1><p>【优先级】中</p><div class="callout callout-note"><p class="callout-title"><svg class="callout-icon" viewBox="0 0 16 16" width="16" height="16"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>说明 该性能优化建议适用于如下产品型号：</p><div data-filter="950"><ul><li>Ascend 950PR&amp;950DT系列产品</li></ul></div></div><p>在非连续搬运场景可以使用DataCopyPad接口的Loop模式和DataCopy的多维数据搬运接口来减少搬运次数，优化搬运性能。</p><h2 id="使用Loop模式减少非连续搬运的次数">使用Loop模式减少非连续搬运的次数<span id="section191811840221"></span><a class="header-anchor" href="#使用Loop模式减少非连续搬运的次数">​</a></h2><p>【描述】DataCopyPad接口在Normal/Compact模式基础上，可以使用Loop模式搬运二维数据，假设我们希望以下图的方式搬运8个48B大小的数据块：</p><p>以下示例中，<code>DataCopyExtParams</code>的<code>blockLen</code>和<code>srcStride</code>、<code>LoopModeParams</code>的stride以及地址布局均以字节描述；<code>DataCopyExtParams</code>的<code>dstStride</code>以32B的dataBlock为单位，本例使用Compact模式时该参数无效并置为0；<code>DataCopyPadExtParams</code>的<code>leftPadding/rightPadding</code>和<code>LocalTensor</code>、<code>GlobalTensor</code>的<code>operator[]</code>偏移均以元素为单位。以下代码假定<code>T</code>为普通的按字节存储类型（如<code>float</code>、<code>half</code>或<code>int8_t</code>），并通过<code>sizeof(T)</code>将字节偏移转换为元素偏移；4bit打包类型需要单独处理。</p><p><img src="'+o+`" alt></p><p>【反例】调用多次搬运接口进行搬运（以DataCopyPad为例）</p><div class="code-block"><div class="code-header"><span class="lang-label">Text</span><button class="copy-btn" title="复制代码"><svg width="16" height="16" viewBox="0 0 16 16"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button></div><pre class="highlight"><code>__aicore__ inline void CopyIn3(){
...
</code></pre></div><p><strong>图2</strong> 使用Loop模式进行搬运<span id="fig26533539233"></span><br><img src="`+e+'" alt title="使用Loop模式进行搬运"></p><p>【总结】当数据块之间需要插入不同大小Padding时，使用Loop模式搬运代替多次的DataCopyPad能够减少搬运指令的使用，提升性能。</p><h2 id="使用多维数据搬运减少非连续搬运次数">使用多维数据搬运减少非连续搬运次数<span id="section1229601461213"></span><a class="header-anchor" href="#使用多维数据搬运减少非连续搬运次数">​</a></h2><p>【描述】假设我们希望以下图的方式搬运2个8B大小的数据块：</p><p><strong>图3</strong> 搬运前后数据<span id="fig20466223158"></span><br><img src="'+d+'" alt title="搬运前后数据"></p><p>【反例】使用多次DataCopyPad进行搬运</p><p><strong>图4</strong> 使用多次DataCopyPad进行搬运<span id="fig18188132522410"></span><br><img src="'+l+`" alt title="使用多次DataCopyPad进行搬运"></p><div class="code-block"><div class="code-header"><span class="lang-label">Text</span><button class="copy-btn" title="复制代码"><svg width="16" height="16" viewBox="0 0 16 16"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button></div><pre class="highlight"><code>__aicore__ inline void CopyIn5(){
...
<span class="p">}</span>
</code></pre></div><p><strong>图5</strong> 搬运前后数据<span id="fig284018179396"></span><br><img src="`+i+'" alt title="搬运前后数据-56"></p><p>【总结】使用多维数据搬运在部分场景下能够减少搬运指令的条数，从而提升性能。</p></article></div>',1)])])}const f=s(r,[["render",m]]);export{u as __pageData,f as default};
