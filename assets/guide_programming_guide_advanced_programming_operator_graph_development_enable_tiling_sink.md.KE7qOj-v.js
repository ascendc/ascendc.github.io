import{_ as t,o as n,a as e,b as a}from"./app.Dfzi9e7Q.js";const r=JSON.parse('{"title":"","description":"","frontmatter":{"breadcrumbs":[{"text":"Ascend C算子开发指南","link":"/guide/getting_started/ascend_c_overview_and_learning_path"},{"text":"编程指南","link":"/guide/programming_guide/document_structure"},{"text":"高级编程","link":"/guide/programming_guide/advanced_programming/advanced_programming"},{"text":"算子入图开发","link":"/guide/programming_guide/advanced_programming/operator_graph_development/overview"},{"text":"开启Tiling下沉","link":"/guide/programming_guide/advanced_programming/operator_graph_development/enable_tiling_sink"}]},"headers":[],"relativePath":"guide/programming_guide/advanced_programming/operator_graph_development/enable_tiling_sink.md","filePath":"guide/programming_guide/advanced_programming/operator_graph_development/enable_tiling_sink.md","lastUpdated":1789956443000}'),l={name:"guide/programming_guide/advanced_programming/operator_graph_development/enable_tiling_sink.md"};function s(o,i,p,g,c,_){return n(),e("div",null,[...i[0]||(i[0]=[a(`<div><article class="markdown-body"><h1>开启Tiling下沉<span id="ZH-CN_TOPIC_0000002130625528"></span></h1><p>在静态图模式下，可以通过<strong>整图下沉</strong>优化调度性能。将完整的计算图一次性下发至Device侧，后续执行则无需Host参与，由Device自主完成计算，从而减少Host-Device交互开销，提升执行效率。部分算子的Tiling计算依赖运行时输入的具体数值（<strong>Tiling值依赖</strong>），需在执行时动态计算Tiling参数。针对该场景，可采用<strong>Tiling下沉</strong>优化方案：将Tiling计算下沉至Device侧的AI CPU上执行，从而实现计算全程在Device侧高效完成。</p><div class="callout callout-note"><p class="callout-title"><svg class="callout-icon" viewBox="0 0 16 16" width="16" height="16"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>说明</p><ul><li>基于新版本CANN包（支持Tiling下沉特性）编译生成的Tiling下沉算子，不兼容旧版CANN（不支持Tiling下沉特性）运行环境。</li><li>当前仅融合算子（矢量计算和矩阵计算融合）支持进行Tiling下沉。</li><li>Tiling下沉功能仅支持如下产品型号： <div data-filter="A3"><ul><li>Atlas A3系列产品</li></ul></div><div data-filter="910b"><ul><li>Atlas A2系列产品</li></ul></div><div data-filter="950"><ul><li>Ascend 950PR&amp;950DT系列产品，暂不支持</li></ul></div></li></ul></div><p>自定义算子开启Tiling下沉的步骤如下，完整样例请参考<a href="https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/02_features/99_acl_based/00_acl_compilation/custom_op">Tiling下沉算子样例</a>。</p><p>Tiling下沉场景下，算子工程的op_host目录结构如下，Tiling实现文件需单独放在一个cpp文件中，示例中为add_custom_tiling_sink_tiling.cpp。</p><div class="code-block"><div class="code-header"><span class="lang-label">Text</span><button class="copy-btn" title="复制代码"><svg width="16" height="16" viewBox="0 0 16 16"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button></div><pre class="highlight"><code>├── op_host
