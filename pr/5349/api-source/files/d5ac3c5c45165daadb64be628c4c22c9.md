...
unsigned short int的数据按位重新解释为bfloat16的值。以下列出典型输入位模式对应的返回值：
...
| 65408（0xFF80） | -inf |
| 32767（0x7FFF） | nan |
| 32639（0x7F7F） | ASCRT_MAX_NORMAL_BF16 |
| 65407（0xFF7F） | -ASCRT_MAX_NORMAL_BF16 |
| 1（0x0001） | ASCRT_MIN_DENORM_BF16 |
| 16256（0x3F80） | 1.0 |
